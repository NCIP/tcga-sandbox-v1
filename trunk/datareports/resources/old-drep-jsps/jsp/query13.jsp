...
<div id="middle" align="center">
    ...
    <div id="results_table">
        ...
        <ec:table
                items="${count[0]}"
                var="gencount"
                title="Count all revised GBM archives by Center (double counts archive if revised twice, etc)"
                filterable="false"
                rowsDisplayed="1"
        ...
        <ec:table
                items="${count[1]}"
                var="gencount"
                title="Count all revised OV archives by Center (double counts archive if revised twice, etc)"
                filterable="false"
                rowsDisplayed="1"
                showPagination="false"
                >
