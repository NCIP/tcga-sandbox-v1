...
<div id="middle" align="center">
    ...
    <div id="results_table">
        ...
        <ec:table
                items="${count[0]}"
                var="gencount"
                title="All GBM platform types in use by Center and Date"
                filterable="false"
                rowsDisplayed="1"
            ...
            <ec:row highlightRow="true">
                ...
                <ec:column property="condition3" title="Platforms"/>
        ...
        <ec:table
                items="${count[1]}"
                var="gencount"
                title="All OV platform types in use by Center and Date"
                filterable="false"
                rowsDisplayed="1"
                showPagination="false"
                >
