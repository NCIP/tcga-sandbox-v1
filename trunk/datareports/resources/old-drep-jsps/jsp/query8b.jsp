...
<div id="middle" align="center">
    ...
    <div id="results_table">
        ...
        <ec:table
                items="${count[0]}"
                var="gencount"
                title="Count all available GBM archives submit to DCC by date (broad/GSC)"
                filterable="false"
                rowsDisplayed="1"
        ...
        <ec:table
                items="${count[1]}"
                var="gencount"
                title="Count all available OV archives submit to DCC by date (broad/GSC)"
                filterable="false"
                rowsDisplayed="1"
                showPagination="false"
                >
