...
<div id="middle" align="center">
    ...
    <div id="results_table">
        ...
        <ec:table
                items="${count[0]}"
                var="gencount"
                title="Date of last GBM archive submitted by Center and Date (broad/CGCC)"
                filterable="false"
                rowsDisplayed="1"
            ...
            <ec:row highlightRow="true">
                ...
                <ec:column property="condition3" title="Last Archive Submisson"/>
        ...
        <ec:table
                items="${count[1]}"
                var="gencount"
                title="Date of last OV archive submitted by Center and Date (broad/CGCC)"
                filterable="false"
                rowsDisplayed="1"
                showPagination="false"
                >
