...
<div id="middle" align="center">
    ...
    <div id="results_table">
        ...
        <ec:table
                items="${count[0]}"
                var="gencount"
                title="Number of distinct GBM sample barcodes received by DCC for each CGCC"
                filterable="false"
                rowsDisplayed="100"
        ...
        <ec:table
                items="${count[1]}"
                var="gencount"
                title="Number of distinct OV sample barcodes received by DCC for each CGCC"
                filterable="false"
                rowsDisplayed="1"
                showPagination="false"
                >
