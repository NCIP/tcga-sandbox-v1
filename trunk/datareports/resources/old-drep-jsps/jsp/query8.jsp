...
<div id="middle" align="center">
    ...
    <div id="results_table">
        ...
        <ec:table
                items="${count[0]}"
                var="gencount"
                title="Count all available GBM archives submit to DCC by center and date"
                filterable="false"
                rowsDisplayed="1"
            ...
            <ec:row highlightRow="true">
                ...
                <ec:column property="count" title="Available"/>
        ...
        <ec:table
                items="${count[1]}"
                var="gencount"
                title="Count all available OV archives submit to DCC by center and date"
                filterable="false"
                rowsDisplayed="1"
                showPagination="false"
                >
            <ec:row highlightRow="true">
                <ec:column property="entity" title="Center Name"/>
                <ec:column property="condition2" title="Center Type"/>
                <ec:column property="count" title="Available in portal"/>
                <ec:column property="condition" title="Since"/>
            </ec:row>
        </ec:table>
    </div>
