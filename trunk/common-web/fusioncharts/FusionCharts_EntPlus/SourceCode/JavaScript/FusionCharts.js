...
(function () {
    ...
    var global = {},
        ...
        argsT = ['swfUrl', 'id', 'width', 'height', 'debugMode',
        'registerWithJS', 'bgColor', 'scaleMode', 'lang',
    ...
    global.extend(global.core, {
         ...
         */
        version: [3, 2, 2, 'servicerelease1', 4200],
...
(function () {
    ...
    ajax.prototype.get = function (url, data) {
        ...
        xmlhttp.onreadystatechange = function () {
            try {
                if (xmlhttp.readyState === 4 && successCallback) {
                    if ((!xmlhttp.status && fileProtocol) || (xmlhttp.status >= 200 &&
                        ...
                        successCallback(xmlhttp.responseText, wrapper, data, url);
                    }
...
(function () {
    ...
    var SCRIPT_NAME_REGEX = /(^|[\/\\])(fusioncharts\.js|fusioncharts\.debug\.js|fusioncharts\.core\.js|fusioncharts\.min\.js|fusioncharts\.packed\.js)([\?#].*)?$/ig,
        BLOCK_EXTERNAL_SCRIPT_LOADING = false,
        SCRIPT_LOAD_TIMEOUTMS = 30000;
    ...
    global.core.options.scriptBaseUri = (function () {
        ...
        for (i = 0; i < l; i += 1) {
            ...
            if (!(src === undefined || src === null ||
                src.match(SCRIPT_NAME_REGEX) === null)) {
                return src.replace(SCRIPT_NAME_REGEX, '$1');
            }
        }
     ...
     */
    var checkBadChars = /[\\\"<>;&]/,
        hasProtocolDef = /^[^\S]*?(sf|f|ht)(tp|tps):\/\//ig,
        LOAD_SUCCESS_EVENTNAME = FusionChartsEvents.ExternalResourceLoad = 'externalresourceload',
    ...
    global.loadScript = function (file, callback, scriptText, includeOnce) {
        ...
        if (scriptsLoaded[src] === true && includeOnce) {
            ...
            if (typeof callback === 'function') {
                callback();
                global.raiseEvent(LOAD_SUCCESS_EVENTNAME, eventArgs, global.core);
            }
            return true;
        }
    ...
    }, lengthCleanupRegex = /[^\%\d]*$/ig, signatureMatchRegex = /^FusionCharts/;
    ...
    global.extend(global.core, {
        ...
        chartType: function () {
            var url;
            return (url = (url = this.src.substring(this.src.indexOf('.swf'), 0)) ?
                url : this.src).substring(url.lastIndexOf('/') + 1).toLowerCase();
        }
    ...
    window.getChartFromId = function (id) {
        global.raiseWarning(this, '11133001041', 'run', 'GenericRuntime~getChartFromId()',
...
// ============================================================================
    ...
    global.extend(global.core, {
        render: function (containerElement) {
            ...
            var alt = document.createElement(this.options.containerElementType || 'span'), insertMode =
                this.options.insertMode.toLowerCase() || 'replace';
...
(function () {
    ...
    try {
        global.swfobject = window.swfobject;
        window.swfobject.createCSS('object.FusionCharts:focus, embed.FusionCharts:focus',
            'outline: none');
    }
    ...
    global.core.hasRequiredFlashVersion = function (version) {
        ...
        window.swfobject.hasFlashPlayerVersion(version) : undefined;
    };
    ...
    probeParamsFromDOM = function (id) {
        ...
        var ref = window.swfobject.getObjectById(id), i, l, paramName, tags,
    ...
    var onBeforeInitialize = function (event) {
        ...
        if (Boolean(obj.options.autoInstallRedirect) === true &&
            !window.swfobject.hasFlashPlayerVersion(
    ...
    var renderer = {
        ...
        render: function (container, callBack) {
            ...
            encodedVars.dataXML = (typeof window.encodeURIComponent === 'function' ?
                window.encodeURIComponent(dataXML) : window.escape(dataXML)) ||
            '';
            ...
            if (global.isXSSSafe(dataURL)) {
                ...
                encodedVars.dataURL = (typeof window.encodeURIComponent === 'function' ?
                    window.encodeURIComponent(dataURL) : window.escape(dataURL)) || '';
            }
            ...
            if (window.swfobject && window.swfobject.embedSWF) {
                ...
                window.swfobject.embedSWF(this.src, container.id, this.width,
    ...
    renderer.prototype = {
        ...
        getSWFHTML: function () {
            ...
            window.swfobject.embedSWF(this.src, tempId, this.width,
            ...
            window.swfobject.removeSWF(tempId);
...
(function () {
    ...
    global.core.options.jQuerySourceFileName = 'jquery.min.js';
    ...
    chartAPI = lib.chartAPI = function() {},
    ...
    hasModule = lib.hasModule = function (name) {
        ...
        // module exists.
        if (moduleMeta[name] && moduleMeta[name].blocked) {
            return true;
        }
        ...
        return Boolean(global.modules['modules.renderer.highcharts-' + name]);
    },

    // Function to call the global loadScript function for loading an html5
    // module.
    loadModule = lib.loadModule = function (name, callback, failure) {
        ...
        loadFile = function () {
            ...
            var meta, metaKey = name[count], userSrc;
            ...
            // Check if loading has been blocked. If yes, then assume that
            // module exists.
            if ((meta = moduleMeta[metaKey]) && meta.blocked) {
                loadFile();
                return;
            }
            ...
            global.core.options['html5' + metaKey + 'Src'];

            global.loadScript(userSrc || meta, {
                success: function () {
    ...
    renderer.render = function (container) {
        ...
        if (chart.options.showLoadingMessage) {
    ...
    renderer.events = {
        'BeforeInitialize': function (event) {
            ...
            if (!chartAPI[chartType]) {
                // Request load of the specific chart module
                renderer.load.call(sender);
            }
        ...
        _doNotLoadExternalScript: function (flags) {
            ...
            for (item in flags) {
                ...
                if (moduleMeta[srcKey]) {
                    moduleMeta[srcKey].blocked = Boolean(flags[item]);
                }
            }
        },
...
(function () {
    ...
    var xml2json = (function () {
        ...
        var parse = {
            ...
            child: function (obj, childNode, parentNodeName, baseObj) {
                var i, nodeName, childObj, temp, rule;
    ...
    var json2xml = (function () {
            ...
            if (obj instanceof Array) {
                ...
                for (item = 0; item < obj.length; item += 1) {
                    ...
                    // another node.
                        ...
                        outerXML += parser(obj[item], namespace, namespaceparent);
                    }
                }
            }
                ...
                for (item in obj) {
                    ...
                    // parent namespace.
                        ...
                        if ((qualifier = rules.qualify('attr', lowerItem, namespace))) {
                            nodeName = parser(obj[item], qualifier, namespace)
                                .replace(/\/\>/ig, '');
                            namespace = lowerItem;
                        }
                        ...
                        // as a child JSON object.
                            ...
                            innerXML += parser(obj[item], lowerItem, namespace);
                        }
                    }
                    // Parse "vLine" and other static rules.
                    else {
                        // Check for text qualifier
                        if ((qualifier = rules.qualify('text', lowerItem, namespace))) {
        ...
        return function (jsonData) {
            ...
            // Call JSON2XML parser to retrieve the parsed data.
            var xmlData = parser(jsonData, jsonData && jsonData.graph ? 'graph' : 'chart', undefined);
