	...
	*/
	private function calculatePoints (isRedraw:Boolean)
	{
		...
		if (this.params.caption != "")
		{
			...
			var captionObj : Object = createText (true, this.params.caption, this.tfTestMC, 1, testTFX, testTFY, 0, this.styleM.getTextStyle (this.objects.CAPTION) , true, this.width - (this.params.chartLeftMargin + this.params.chartRightMargin), this.height/4);
			//Store the height
		...
		{
			//Create text field to get height
			var subCaptionObj : Object = createText (true, this.params.subCaption, this.tfTestMC, 1, testTFX, testTFY, 0, this.styleM.getTextStyle (this.objects.SUBCAPTION) , true, this.width - (this.params.chartLeftMargin + this.params.chartRightMargin), this.height/4);
			//Store the height
	...
	*/
	private function drawHeaders ()
	{
		...
		if (this.params.yAxisName != "")
		{
			...
			var yAxisNameObj : Object = createText (false, this.params.yAxisName, this.cMC, this.dm.getDepth ("YAXISNAME") , this.width/2 , this.elements.canvas.toY + this.config.yValAreaHeight + this.config.trendValAreaHeight + this.params.yAxisNamePadding, 0, yAxisNameStyleObj, true, this.width - (this.params.chartLeftMargin+this.params.chartRightMargin), this.elements.yAxisName.h);
			//Apply animation
			if (this.params.animation)
			{
			...
			for (j = 1; j <= this.num; j ++)
			{
				...
				if (this.dataset [i].data [j].isDefined && this.dataset [i].data [j].showValue)
				{
					...
					if(this.dataset [i].data [j].displayValueDefined){
						...
						if(valueObj.width > this.dataset [i].data [j].w){
