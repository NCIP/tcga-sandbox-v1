	...
	*/
	private function preparePercentData():Void {
		...
		if (this.params.stack100Percent) {
				...
				for (j=1; j<=this.dataset[i].numSDS; j++) {
					for (k=1; k<=this.num; k++) {
						if (this.dataset[i].dataset[j].data[k].isDefined) {
							...
							percentValue = (this.dataset[i].dataset[j].data[k].value/this.dataset[i].sums[k].sum)*100;
			...
			for (i=1; i<=this.num; i++) {
				for (j=1; j<=this.numDS; j++) {
					this.dataset[j].sums[i].displayValue = formatNumber(this.dataset[j].sums[i].sum, this.params.formatNumber, this.params.decimals, this.params.forceDecimals, this.params.formatNumberScale, this.params.defaultNumberScale, this.config.nsv, this.config.nsu, this.params.numberPrefix, this.params.numberSuffix);
				}
			}
