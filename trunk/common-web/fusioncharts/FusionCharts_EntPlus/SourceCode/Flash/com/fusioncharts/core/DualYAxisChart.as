...
class com.fusioncharts.core.DualYAxisChart extends Chart 
{
	...
	*/
	private function returnDataAsPDivLine (value : Number) : Object 
	{
		...
		//Display value
		divLineObject.displayValue = this.formatNumber (value, this.params.formatNumber, this.params.yAxisValueDecimals, this.params.forceYAxisValueDecimals, this.params.formatNumberScale, this.params.defaultNumberScale, this.config.nsv, this.config.nsu, this.params.numberPrefix, this.params.numberSuffix);
		//Flag to show values
	...
	*/
	private function returnDataAsSDivLine (value : Number) : Object 
	{
		...
		divLineObject.value = value;
		//Display value
		divLineObject.displayValue = this.formatNumber (value, this.params.sFormatNumber, this.params.sYAxisValueDecimals, this.params.forceSYAxisValueDecimals, this.params.sFormatNumberScale, this.params.sDefaultNumberScale, this.config.snsv, this.config.snsu, this.params.sNumberPrefix, this.params.sNumberSuffix);
		//Flag to show values
		divLineObject.showValue = true;
		return divLineObject;
	}
		...
		for (i = 0; i <= this.numTrendLines; i ++)
		{
			...
			} else 
			{
				...
				else
				{
					...
					{
						//We resolve displayValue conflict
						this.trendLines [i].displayValue = getFV (this.trendLines [i].displayValue, this.formatNumber (this.trendLines [i].endValue, this.params.sFormatNumber, this.params.sYAxisValueDecimals, this.params.forceSYAxisValueDecimals, this.params.sFormatNumberScale, this.params.sDefaultNumberScale, this.config.snsv, this.config.snsu, this.params.sNumberPrefix, this.params.sNumberSuffix));
					}
				}
			}
		}
