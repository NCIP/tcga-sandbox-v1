...
class com.fusioncharts.core.charts.StackedArea2DChart extends SingleYAxis2DVerticalChart 
{
	...
	*/
	private function parseAttributes (graphElement : XMLNode) : Void 
	{
		...
		this.params.canvasPadding = getFN (atts ["canvaspadding"]);
	...
	private function calculatePoints (isRedraw:Boolean)
	{
		...
		if(this.params.XTLabelManagement){
			...
			if(labelMetrics.changeCanvasPadding){
				...
				var spaceAtLeft:Number = this.config.leftPanelMinWidth;
				if(metricsObj.leftPanelWidth > this.config.leftPanelMinWidth){
				...
				var spaceAtRight:Number = this.config.rightPanelMinWidth;
