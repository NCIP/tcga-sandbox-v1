	...
	private function drawXAxisPercentValues():Void{
		...
		if (this.params.showXAxisPercentValues){
			...
			for (i = 1; i < this.num; i ++)
			{
				...
				displayValue = formatNumber (cumSum, this.params.formatNumber, this.params.decimals, this.params.forceDecimals, false, this.params.defaultNumberScale, this.config.nsv, this.config.nsu, "", "%");
				//Create the label
