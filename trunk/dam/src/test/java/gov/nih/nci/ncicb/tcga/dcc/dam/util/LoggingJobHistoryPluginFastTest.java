...
/**
 * LoggingJobHistoryPlugin unit tests
 *
 ...
 */
@RunWith(JMock.class)
public class LoggingJobHistoryPluginFastTest {
    ...
    private LoggingJobHistoryPlugin loggingJobHistoryPlugin;
    ...
    public void setUp() {
        ...
        loggingJobHistoryPlugin = new LoggingJobHistoryPlugin();
        loggingJobHistoryPlugin.setLog(mockLog);
    }
    ...
    public void testInit() throws SchedulerException {
        ...
        mockery.checking(new Expectations() {{
            one(mockScheduler).addGlobalJobListener(loggingJobHistoryPlugin);
        }});

        final String expectedPluginName = "test plugin";
        loggingJobHistoryPlugin.initialize(expectedPluginName, mockScheduler);

        assertEquals("Unexpected plugin name:", expectedPluginName, loggingJobHistoryPlugin.getName());
    }
    ...
    public void testJobToBeExecutedInfoLogDisabled() throws SchedulerException {
        ...
        loggingJobHistoryPlugin.jobToBeExecuted(fakeJobExecutionContext);
    }
    ...
    public void testJobExecutionVetoedInfoLogDisabled() {
        ...
        loggingJobHistoryPlugin.jobExecutionVetoed(fakeJobExecutionContext);
    }
    ...
    public void testJobWasExecuted() throws SchedulerException {
        ...
        loggingJobHistoryPlugin.jobWasExecuted(fakeJobExecutionContext, null);
    }
