 ...
 * @version $Rev$
 */
public class LungPathology extends Pathology {
    ...
    private static final String insertSQL = "insert into LUNG_PATHOLOGY (HISTOLOGICNUCLEARGRADE, " +
            "TUMORSAMPLEANATOMICLOCATION, " +
            "TNMPATHOLOGYSTAGEGROUPING, " +
            "TNMPATHOLOGYTUMORSTATUS, " +
            "TNMPATHOLOGYLYMPHNODESTATUS, " +
