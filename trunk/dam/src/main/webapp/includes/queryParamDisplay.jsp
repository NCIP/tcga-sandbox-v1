<div id="quereyResults">
    ...
    <%
        ...
        final String[] archiveTypeVals = (String[]) request.getSession().getAttribute("archiveTypeVals");
    ...
    <table style="border: solid 0px #999999;" cellpadding="5" cellspacing="0" align="center" bgcolor="#F3F3F3"
        ...
        <c:if test="${archiveTypeVals[0] != null}">
            <tr>
                <td valign="top"><strong>Archive Types</strong></td>
                <td bgcolor="white">
                    <c:forEach items="${archiveTypeVals}" var="archiveTypeParam">
                        <c:forEach items="${archiveTypes}" var="archiveType">
                            <c:if test="${archiveType.archiveTypeId == archiveTypeParam}">
                                * <c:out value="${archiveType.archiveType}"/><br>
                            </c:if>
                        </c:forEach>
                    </c:forEach>
                </td>
