	...
	pictures = $('#thumsSlide div img').length;
	width = $('#p1 img').outerWidth();
	
	/* initial set up */
	$('#thumsSlide div img').animate({opacity: 1});
	$('#thumsSlide #b1 img').animate({opacity: 1});
	$('#thumsSlide #b1 img').css("borderColor","#c1c1c1");
	...
	$("#wrapSlide").mouseover(function() {clearTimeout(timer);});
	$("#wrapSlide").mouseout(function() {timer = setTimeout ("autoPlay()", showTime);});
	...
	(function($) {
		...
		{						
			...
			this.innerWrapper = $(container).wrapInner('<div style="position:absolute;width:844px;height:420px;"/>').children()[0];
			...
			{											
				...
				var smallRange = (1-minScale) *0.45;
	...
	//		func = function(){return;ctx.updateAll();} ;
			...
			this.checkImagesLoaded = function()
			{
				...
				this.autoRotate();	
				this.updateAll();
                $('#carousel1').css('visibility','visible');					
			};
	...
	$(".hoverMenu").hoverIntent({
		 sensitivity: 0, // number = sensitivity threshold (must be 1 or higher)
	});
