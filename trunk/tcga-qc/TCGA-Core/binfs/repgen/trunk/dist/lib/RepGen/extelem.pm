# $Id: extelem.pm 7628 2010-07-26 16:45:32Z jensenma $
package RepGen::extelem;

=NAME

RepGen::extelem - repgen.pl configuration for exchange.tab (BAM file) telemetry reports

=SYNOPSIS

Autoincluded  in repgen.pl when specified at command line:
 
 perl repgen.pl extelem ...
