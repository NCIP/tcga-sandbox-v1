#!/bin/perl -w
# $Id: MyUsage.pm 17870 2012-11-08 22:35:30Z snyderee $
####################################################################################################
...
#	deal with special case of user entering -V for version information
...
#	support -M option to generate man page based on POD in main
...
#	deal with user input errors
	...
	my $infile_check = 1;
	$infile_check = 0 if( @ARGV >= @$infiles );
