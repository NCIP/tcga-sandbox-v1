...
<html xmlns="http://www.w3.org/1999/xhtml">
      <head>
		...
		<body 
			onload="MM_preloadImages('../images/nav_about_tcga_data_ovr.gif',
			'images/nav_analyse_data_in_cma_ovr.gif',
			'images/nav_browse_data_ovr.gif',
			'images/nav_data_access_ovr.gif',
			'images/nav_portal_help_ovr.gif')">
				...
				onmouseover="MM_swapImage('about','','/tcga/images/layout/nav_about_tcga_data_ovr.gif',1)">
				            <img 
				...
				onmouseout="MM_swapImgRestore()" 
				onmouseover="MM_swapImage('help','','/tcga/images/layout/nav_portal_help_ovr.gif',1)">
				            <img 
				...
				onmouseout="MM_swapImgRestore()" 
				onmouseover="MM_swapImage('access','','/tcga/images/layout/nav_data_access_ovr.gif',1)">
				            <img 
				...
				onmouseout="MM_swapImgRestore()" 
				onmouseover="MM_swapImage('browse','','/tcga/images/layout/nav_browse_data_ovr.gif',1)">
				            <img 
				...
				onmouseout="MM_swapImgRestore()" 
				onmouseover="MM_swapImage('cma','','/tcga/images/layout/nav_analyse_data_in_cma_ovr.gif',1)">
				            <img 
			...
			<div style="width: 100%;height: auto;">
			   <div style="width: 855px; margin: auto;padding: 15px 0 15px 0;">
					<div style="font-family: 'Courier New', Courier, monospace;font-size: 24px; line-height: 24px; font-weight:bold; color: #00667C;margin: 0 0 10px 10px;">UUID Manager</div> 

	            <div id="uuidManager"></div>
				</div>					
			</div>					
