...
/**
 * Test class for RNASeqRSEMIsoformNormalizedFileValidator
 *
 * @author Stan Girshik
 ...
 */
@RunWith(JMock.class)
public class RNASeqRSEMIsoformNormalizedFileValidatorFastTest {

    private Mockery context;
    RNASeqRSEMIsoformNormalizedFileValidator validator;
    ...
    public void setUp() {
        ...
        validator = new RNASeqRSEMIsoformNormalizedFileValidator();
    ...
    public void testProcessValidFile() throws ProcessorException {
        ...
        File validFile = new File(TEST_FILE_DIR + File.separator + "unc.edu.TCGA-44-3918-01A-01R-1107-07.952034.rsem.isoforms.normalized_results");
    ...
    public void testProcessValidUUIDFile() throws ProcessorException {
        ...
        File validFile = new File(TEST_FILE_DIR + File.separator + "unc.edu.d59d48ca-16e5-46c0-80e8-6d1214acd156.952034.rsem.isoforms.normalized_results");
        assertTrue(validator.processFile(validFile, qcContext));
    }
    ...
    public void testProcessInValidFile() throws ProcessorException {
        ...
        File validFile = new File(TEST_FILE_DIR + File.separator + "invalid.TCGA-44-3918-01A-01R-1107-07.952034.rsem.isoforms.normalized_results");
        ...
        assertEquals("An error occurred while validating RNA sequence data file " +
                "'invalid.TCGA-44-3918-01A-01R-1107-07.952034.rsem.isoforms.normalized_results':  " +
                "line 3: number of fields should be 2 but is 1. [1.4045]", qcContext.getErrors().get(0));
    }
