README for archive broad.mit.edu_GBM.HT_HG-U133A.Level_2.6.1002.0

This file was automatically generated on 01/27/2010 using the TCGA DCC Archive Processing System.
...
with Glioblastoma multiforme (GBM). The data was produced by the Broad Institute of MIT and Harvard
(broad.mit.edu) Cancer Genomic Characterization Center (CGCC) using the Affymetrix HT Human Genome
U133 Array Plate Set platform.

This archive is the 1002nd revision of the 6th archive and contains only Level 2 (processed) data.
