ALTER TABLE LUSC_PATHOLOGY DROP CONSTRAINT LUSCPATH_HNUCLEARGRADE_CC;
ALTER TABLE LUSC_PATHOLOGY DROP  CONSTRAINT LUSCPATH_TANATOMICLOCATION_CC;
ALTER TABLE LUSC_PATHOLOGY DROP  CONSTRAINT LUSCPATH_TNMPLYMPHNODESTAT_CC;
ALTER TABLE LUSC_PATHOLOGY DROP  CONSTRAINT LUSCPATH_TNMPMETASTATICSTAT_CC;
ALTER TABLE LUSC_PATHOLOGY DROP  CONSTRAINT LUSCPATH_TNMPSTAGEGROUPING_CC;
ALTER TABLE LUSC_PATHOLOGY DROP  CONSTRAINT LUSCPATH_TNMPTUMORSTATUS_CC;

ALTER TABLE LUSCSLIDE DROP  CONSTRAINT LUSCSLIDE_ENDOPROLIFERATION_CC;
ALTER TABLE LUSCSLIDE DROP  CONSTRAINT LUSCSLIDE_NUCLEARPLEO_CC;
ALTER TABLE LUSCSLIDE DROP  CONSTRAINT LUSCSLIDE_PNECROSIS_CC;
ALTER TABLE LUSCSLIDE DROP  CONSTRAINT LUSCSLIDE_CELLULARITY_CC;
