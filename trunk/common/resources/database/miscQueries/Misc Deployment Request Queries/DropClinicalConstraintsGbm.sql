ALTER TABLE GBMSLIDE DROP CONSTRAINT GBMSLIDE_ENDOPROLIFERATION_CC;
ALTER TABLE GBMSLIDE DROP  CONSTRAINT GBMSLIDE_NUCLEARPLEO_CC;
ALTER TABLE GBMSLIDE DROP  CONSTRAINT GBMSLIDE_PNECROSIS_CC;
ALTER TABLE GBMSLIDE DROP  CONSTRAINT GBMSLIDE_CELLULARITY_CC;

ALTER TABLE GBM_PATHOLOGY DROP CONSTRAINT GBMPATH_HISTOLOGICTYPE_CC;
ALTER TABLE GBM_PATHOLOGY DROP  CONSTRAINT GBMPATH_HNUCLEARGRADE_C;
ALTER TABLE GBM_PATHOLOGY DROP  CONSTRAINT GBMPATH_GEMISTOCYTESPRESENT_CC;
ALTER TABLE GBM_PATHOLOGY DROP  CONSTRAINT GBMPATH_GFAP_C;
ALTER TABLE GBM_PATHOLOGY DROP  CONSTRAINT GBMPATH_TANATOMICLOCATION_C;
ALTER TABLE GBM_PATHOLOGY DROP  CONSTRAINT GBMPATH_OLIGODENDCOMP_CC;
ALTER TABLE GBM_PATHOLOGY DROP  CONSTRAINT GBMPATH_LEPTOMENINVOLE_C;
ALTER TABLE GBM_PATHOLOGY DROP  CONSTRAINT GBMPATH_MIB1_CC;
