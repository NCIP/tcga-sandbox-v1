...
CREATE OR REPLACE VIEW shipped_biospecimen_breakdown AS
 ...
 ALTER TABLE projectOverview_case_counts ADD (gcc_lowpass_cases NUMBER(38),
                                              gsc_lowpass_cases NUMBER(38));
...
END;
/
grant select on participant_uuid_file to commonread;
grant all on participant_uuid_file to commonmaint;