...
Insert into CLINICAL_TABLE
 ...
 Values
   (1, 'PATIENT', 'PATIENT.PATIENT_ID=SAMPLE.PATIENT_ID', ' ', 'PATIENT_BARCODE', 16, 'patient', 'PATIENT_ELEMENT', null, 'PATIENT_ID', 'PATIENT_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (2, 'SAMPLE', ' ', 'SAMPLE.PATIENT_ID=PATIENT.PATIENT_ID', 'SAMPLE_BARCODE', 18, 'sample', 'SAMPLE_ELEMENT', 1, 'SAMPLE_ID', 'SAMPLE_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (3, 'PORTION', 'PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID', 'PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID AND SAMPLE.PATIENT_ID=PATIENT.PATIENT_ID', 'PORTION_BARCODE', 17, 'portion', 'PORTION_ELEMENT', 2, 'PORTION_ID', 'PORTION_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (4, 'ANALYTE', 'ANALYTE.PORTION_ID=PORTION.PORTION_ID AND PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID', 'ANALYTE.PORTION_ID=PORTION.PORTION_ID AND PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID AND SAMPLE.PATIENT_ID=PATIENT.PATIENT_ID', 'ANALYTE_BARCODE', 15, 'analyte', 'ANALYTE_ELEMENT', 3, 'ANALYTE_ID', 'ANALYTE_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (5, 'ALIQUOT', 'ALIQUOT.ANALYTE_ID=ANALYTE.ANALYTE_ID AND ANALYTE.PORTION_ID=PORTION.PORTION_ID AND PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID', 'ALIQUOT.ANALYTE_ID=ANALYTE.ANALYTE_ID AND ANALYTE.PORTION_ID=PORTION.PORTION_ID AND PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID AND SAMPLE.PATIENT_ID=PATIENT.PATIENT_ID', 'ALIQUOT_BARCODE', 14, 'aliquot', 'ALIQUOT_ELEMENT', 4, 'ALIQUOT_ID', 'ALIQUOT_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
...
Insert into CLINICAL_TABLE
  (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (10, 'SLIDE', 'SLIDE.PORTION_ID(+)=PORTION.PORTION_ID AND PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID', 'SLIDE.PORTION_ID(+)=PORTION.PORTION_ID AND PORTION.SAMPLE_ID=SAMPLE.SAMPLE_ID AND SAMPLE.PATIENT_ID=PATIENT.PATIENT_ID', 'SLIDE_BARCODE', 20, 'slide', 'SLIDE_ELEMENT', 3, 'SLIDE_ID', 'SLIDE_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (12, 'EXAMINATION', 'EXAMINATION.PATIENT_ID(+)=PATIENT.PATIENT_ID AND PATIENT.PATIENT_ID=SAMPLE.PATIENT_ID', 'EXAMINATION.PATIENT_ID(+)=PATIENT.PATIENT_ID', 'EXAM_BARCODE', 182, 'examination', 'EXAMINATION_ELEMENT', 1, 'EXAMINATION_ID', 'EXAMINATION_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (13, 'RADIATION', 'RADIATION.PATIENT_ID(+)=PATIENT.PATIENT_ID AND PATIENT.PATIENT_ID=SAMPLE.PATIENT_ID', 'RADIATION.PATIENT_ID(+)=PATIENT.PATIENT_ID', 'RADIATION_BARCODE', 180, 'radiation', 'RADIATION_ELEMENT', 1, 'RADIATION_ID', 'RADIATION_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (14, 'SURGERY', 'SURGERY.PATIENT_ID(+)=PATIENT.PATIENT_ID AND PATIENT.PATIENT_ID=SAMPLE.PATIENT_ID', 'SURGERY.PATIENT_ID(+)=PATIENT.PATIENT_ID', 'SURGERY_BARCODE', 181, 'surgery', 'SURGERY_ELEMENT', 1, 'SURGERY_ID', 'SURGERY_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
   (15, 'DRUG_INTGEN', 'DRUG_INTGEN.PATIENT_ID(+)=PATIENT.PATIENT_ID AND PATIENT.PATIENT_ID=SAMPLE.PATIENT_ID', 'DRUG_INTGEN.PATIENT_ID(+)=PATIENT.PATIENT_ID', 'DRUG_BARCODE', 179, 'drug', 'DRUG_INTGEN_ELEMENT', 1, 'DRUG_ID', 'DRUG_INTGEN_ARCHIVE');
Insert into CLINICAL_TABLE
   (CLINICAL_TABLE_ID, TABLE_NAME, JOIN_FOR_SAMPLE, JOIN_FOR_PATIENT, BARCODE_COLUMN_NAME, BARCODE_ELEMENT_ID, ELEMENT_NODE_NAME, ELEMENT_TABLE_NAME, PARENT_TABLE_ID, TABLE_ID_COLUMN_NAME, ARCHIVE_LINK_TABLE_NAME)
 Values
