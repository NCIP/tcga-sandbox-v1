DROP TABLE samples_sent_by_bcr;
...
DROP TABLE latest_samples_received_by_dcc;
...
$BODY$
	...
	*/
	...
	(tumor_abbreviation, center_id, center_name, center_type, platform, biospecimen_id, barcode, sample, portion_analyte, is_valid, is_viewable)
	...
	*/
	...
	(tumor_abbreviation,center_id,center_name,center_type,biospecimen_id,barcode,sample,portion_analyte) 
	SELECT distinct t.tumor_abbreviation,c.id as center_id,c.center_name,m.center_type,b.biospecimen_id,b.barcode,b.sample,b.portion_analyte
